...
for file_i in files_list:
    ...
    text_options = ["UAV picture of a city in the Netherlands", "UAV picture of a city in the USA", "UAV picture of a city in China", "UAV picture of a city in India", "UAV picture of a city in Brazil", "UAV picture of a city in Russia", "UAV picture of a city in Germany", "UAV picture of a city in France"]
